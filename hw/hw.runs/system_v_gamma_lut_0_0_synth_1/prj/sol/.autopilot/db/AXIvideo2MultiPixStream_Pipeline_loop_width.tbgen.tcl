...
set C_modelArgMapList {[ 
	{ "Name" : "sof_4", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "trunc_ln166_1", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ imgRgb_din sc_out sc_lv 120 signal 4 } 
	...
	{ trunc_ln166_1 sc_in sc_lv 8 signal 3 } 
	{ s_axis_video_TDATA sc_in sc_lv 120 signal 5 } 
	{ s_axis_video_TREADY sc_out sc_logic 1 inacc 11 } 
	{ s_axis_video_TKEEP sc_in sc_lv 15 signal 6 } 
	{ s_axis_video_TSTRB sc_in sc_lv 15 signal 7 } 
	...
	{ axi_data_3_out sc_out sc_lv 120 signal 13 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "trunc_ln166_1", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "trunc_ln166_1", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	trunc_ln166_1 { ap_none {  { trunc_ln166_1 in_data 0 8 } } }
