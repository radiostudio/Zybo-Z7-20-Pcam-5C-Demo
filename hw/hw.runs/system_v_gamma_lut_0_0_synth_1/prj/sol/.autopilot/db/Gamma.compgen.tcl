...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_imgRgb \
    op interface \
    ports { imgRgb_dout { I 120 vector } imgRgb_num_data_valid { I 5 vector } imgRgb_fifo_cap { I 5 vector } imgRgb_empty_n { I 1 bit } imgRgb_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { imgGamma_din { O 120 vector } imgGamma_num_data_valid { I 5 vector } imgGamma_fifo_cap { I 5 vector } imgGamma_full_n { I 1 bit } imgGamma_write { O 1 bit } } \
} "
}
