...
entity system_v_demosaic_0_0_AXIvideo2MultiBayer_Pipeline_loop_wait_for_start is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of system_v_demosaic_0_0_AXIvideo2MultiBayer_Pipeline_loop_wait_for_start is 
...
begin
    ...
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
            if ((ap_phi_mux_sof_phi_fu_82_p4 = ap_const_lv1_0)) then 
                ...
                axi_data_out <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
            else 
                axi_data_out <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
            end if;
        else 
    ...
    axi_last_out_ap_vld_assign_proc : process(ap_CS_fsm_state1, ap_phi_mux_sof_phi_fu_82_p4, ap_block_state1_pp0_stage0_iter0)
    begin
        if (((ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_phi_mux_sof_phi_fu_82_p4 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
