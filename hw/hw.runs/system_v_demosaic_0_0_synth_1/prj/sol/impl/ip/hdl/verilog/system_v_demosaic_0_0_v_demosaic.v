...
wire   [39:0] AXIvideo2MultiBayer_U0_imgBayer_din;
...
wire   [119:0] Debayer_U0_imgRgb_din;
...
wire   [119:0] ZipperRemoval_U0_imgUnzip_din;
...
system_v_demosaic_0_0_fifo_w40_d2_S imgBayer_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
system_v_demosaic_0_0_fifo_w120_d2_S imgRgb_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
system_v_demosaic_0_0_fifo_w120_d2_S imgUnzip_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
